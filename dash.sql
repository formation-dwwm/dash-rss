...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 25 fév. 2020 à 13:40
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  `state` enum('Triage','Published','Removed') NOT NULL,
...
ALTER TABLE `access`
  ...
  ADD CONSTRAINT `access_theme_FK` FOREIGN KEY (`id`) REFERENCES `theme` (`id`);
...
ALTER TABLE `content`
  ...
  ADD CONSTRAINT `content_tag_FK` FOREIGN KEY (`id`) REFERENCES `tag` (`id`);
