 ...
 */
final class Version20200227100615 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE id_source id_source INT NOT NULL, CHANGE id_theme id_theme INT NOT NULL');
